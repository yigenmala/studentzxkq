...
<%
	Teacher teac = (Teacher)session.getAttribute("admin");
	String tid = null; 
	if(null == teac) {
		tid = "";
	} else {
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">班级</span></div></td>
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">专业<br /></span></div><br /></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">基本操作</span></div></td>
      </tr>
      <%
      		com.kaoqin.db.Conn conn = new com.kaoqin.db.Conn();
      		ResultSet rs = conn.executeQuery("select id,sid,pass,sname,sex,age,zy,tname,tclass,zy from dm_view where  student.course = teacher.course order by tclass desc");
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%=rs.getString("zy") %></div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><img width="10" height="10" src="images/del.gif" /><a href="dm.jsp?tid=<%=rs.getString("teacher") %>&sid=<%=rs.getString("id") %>&ktype=yidao">已到</a> | <img width="10" height="10" src="images/edit.gif" /><a href="dm.jsp?tid=<%=rs.getString("teacher") %>&sid=<%=rs.getString("id") %>&ktype=kuangke">旷课</a></div></td>
      </tr>
	  <%
	  	}
	  		conn.close();
