...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="1031" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()" height="267">
      <tr>
        <td width="28%" height="20" bgcolor="d3eaef" class="STYLE10"><div align="center">职工编号：</div></td>
        <td width="72%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="left"><input type="text" name="Tid" value="<%=tec.getTid() %>" disabled="disabled" /><input type="hidden" name="tid" value="<%=tec.getTid() %>"/></div></td>
      </tr>
      <tr>
	  ...
	  <tr>
        <td height="20" bgcolor="d3eaef" class="STYLE10"><div align="center">办公室：</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="left">
          <input type="text" name="office" value="<%=tec.getOffice() %>" />
        </div></td>
      </tr>
	  <tr>
        <td height="20" bgcolor="d3eaef" class="STYLE10"><div align="center">课程名：</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="left">
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="33%">&nbsp;</td>
        <td width="67%"><input type="submit" value=" << 修 改  " /></td>
      </tr>
    </table></td>
  </tr>
</table>
