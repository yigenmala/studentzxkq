  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="13%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">班级</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">专业</span></div></td>
      ...
      <%
      		...
      		ResultSet rs = conn.executeQuery("select id,sid,pass,sname,sex,tclass,zy,remark from student");
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><img width="10" height="10" src="images/del.gif" /><a href="delStudent?id=<%=rs.getString("id") %>" onclick="javascript:return confirm('是否要删除？');"> 删除 </a> |<img width="10" height="10" src="images/edit.gif" /><a href="updateStudent.jsp?id=<%=rs.getString("id") %>"> 编辑</a></div></td>
      </tr>
      <%
      		} 
      		rs.close();
